...
## 总结：同一个局域网下,搜索wifi下的网络打印机,推荐使用自定义MedicalReportView画报告图，然后预览和打印报告，因为不仅更高效分辨率最清晰
## 总结：同一个局域网下,搜索wifi下的网络打印机,推荐使用自定义MedicalReportView画报告图，然后预览和打印报告，因为不仅更高效分辨率最清晰
## 总结：同一个局域网下,搜索wifi下的网络打印机,推荐使用自定义MedicalReportView画报告图，然后预览和打印报告，因为不仅更高效分辨率最清晰
...
#### 最新更新功能（自定义MedicalReportView画报告图，图片来源于网络图），PrintDemoA4Activity，可以直接下载Demo查看，功能查看代码即可。
* MedicalReportView画报告图，然后预览打印即可
* 0，自定义View
* 1，PrintDemoA4Activity界面直接点击打印报告,进行预览,和打印报告操作
* 效果请看
